...
const licenses = await readFile(resolve(root, 'licenses.html'), 'utf8')
...
if (!html.includes('href="privacy.html"') || !html.includes('href="terms.html"') || !html.includes('href="licenses.html"') || !privacy.includes('data-lang="en"') || !privacy.includes('data-lang="zh"') || !terms.includes('data-lang="en"') || !terms.includes('data-lang="zh"') || !licenses.includes('data-lang="en"') || !licenses.includes('data-lang="zh"') || !legalJs.includes('meimind-language')) throw new Error('legal pages are not linked or bilingual')
if (!licenses.includes('data-legal-page="licenses"') || terms.includes('data-license-section') || html.includes('README.md#-data-sources')) throw new Error('source licenses must have a dedicated page')
if (!app.includes("prompt-gallery-return") || !html.includes('id="backToTop"') || !app.includes('window.scrollTo({ top: 0')) throw new Error('return-position or back-to-top contract missing')
